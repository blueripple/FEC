## Swagger Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `OpenFEC` 

The library in `lib` provides auto-generated-from-Swagger [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the OpenFEC API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | OpenFEC                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | openfec                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | OpenFECConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | OpenFECRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| OpenFEC.Client    | use the "dispatch" functions to send requests       |
| OpenFEC.Core      | core funcions, config and request types             |
| OpenFEC.API       | construct api requests                              |
| OpenFEC.Model     | describes api models                                |
| OpenFEC.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| OpenFEC.ModelLens | lenses for model fields                             |
| OpenFEC.Logging   | logging functions and utils                         |
